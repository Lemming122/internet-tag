...
class GameInfo:
    def __init__(self) -> None:
        ...
        self.MothershipJwtSecret: str = "asgdfessduifgasiudgyiusdfgf8sdgtfd97gsd978sdgfgsdfuifgsiudfgiusdfgiusdgfiusgdiugsidgf"  # Set this to a long random secret string
...
SuccessfulAuthy = "https://discord.com/api/webhooks/1524203030138851489/bkYLri0LUuXxxLx1WaKWyrTal4TZV6NmRNhzxMjyXsyIGmeL80f9H8SLe8p4AEhRdkXH"
FailedAuthy = "https://discord.com/api/webhooks/1524203030138851489/bkYLri0LUuXxxLx1WaKWyrTal4TZV6NmRNhzxMjyXsyIGmeL80f9H8SLe8p4AEhRdkXH"
...
def titledata():
    ...
    response_data = {
        ...
        "MOTD": "<color=orange>WELCOME TO INTERNET TAG</color>  <color=green>HAVE FUN!</color>  <color=red>CREDS TO HARMODIH</color>  <color=red>OLD APPLAB WAS INTER TAG!</color>  <color=yellow>IF YOU ENJOY THE GAME, PLEASE GIVE IT  (5 STARS)!</color> <color=yellow>hDISCORD.GG/INTERNETTAG</color>",
        "SeasonalStoreBoardSign": "<color=#ff7241>NOWRUZ!</color>",
        "TOS_2024.09.20": "DISCORD.GG/INTERNETTAG",
        "TOBAlreadyOwnCompTxt": "DISCORD.GG/INTERNETTAG",
        "TOBAlreadyOwnPurchaseBundle": "INTERNETTAG",
        "TOBDefCompTxt": "DISCORD.GG/INTERNETTAG",
        "TOBDefPurchaseBtnDefTxt": "INTERNETTAG",
        "UseLegacyIAP": False
