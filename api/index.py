    ...
    return """
        <html>
            ...
            <body style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #004d00, #00cc00); color: white; text-align: center; padding: 50px;">
                ...
                <p style="font-size: 18px;">Internet Tag!</p>
                <img src="https://aicdn.picsart.com/275c6ae1-73a4-4cee-b3f5-45ccfa4499ae.png" alt="Hey If U See This Spread The Gospel" style="max-width: 500px; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); display: block; margin: 30px auto;">
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>discord.gg/wAShdc4sf</color>",
        "BundleKioskButton": "<color=#ff4141>discord.gg/wAShdc4sf</color>",
        "BundleKioskSign": "<color=#ff4141>discord.gg/wAShdc4sf</color>",
        "BundleLargeSign": "<color=#ff4141>discord.gg/wAShdc4sf</color>",
        ...
        "TOS_2024.09.20": "discord.gg/wAShdc4sf",
        ...
        "NewsFeedUrl": "https://discord.gg/wAShdc4sf",
        ...
        "BanAppealUrl": "https://discord.gg/wAShdc4sf",
        ...
        "FeedbackSubmissionUrl": "https://discord.gg/wAShdc4sf/feedback"
    }
