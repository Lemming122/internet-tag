...
def titled_data():
    return jsonify({"MOTD":" WELCOME TOO INTERNET TAG, OUR OWNERS ARE BOBA AND HARMONY, STAFF TEAM : ZEON,AVII,CHEEZIT,KAT, HAVE A GOOD DAY. ALSO discord.gg/JzBZhWqfU "})
